...
/*<section class="characters container">
		<div class="characters__block"><img src="img/hermione.jpg" alt="character-photo" class="characters__image">
			<div class="characters__content">
				<div class="character__name">Hermione Granger</div>
				<div class="character__info">Actor: Emma Watson <br> Gender: female <br> House: Gryffindor <br> Wand core: dragon
					heartstring
					<br> Alive: yes
				</div>
			</div>
